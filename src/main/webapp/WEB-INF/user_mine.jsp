    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
		    	...
		    	<form class="layui-form" action="/user/fixinfo" method="post" style="width: 90%;padding-top: 20px;">


					<div class="layui-form-item">
						<label class="layui-form-label">用户编号：</label>
						<div class="layui-input-block">
							<input type="text" id="id1" name="uId"  value="${user.UId}" class=" layui-input layui-disabled" >
						</div>
					</div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" id="id" name="username"  value="${user.username}" class=" layui-input layui-disabled" >
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text"  id="age" name="age" value="${user.age}" class="layui-input" >
				    </div>
				  </div>
				  <div class="layui-form-item">
				    <label class="layui-form-label">电话号码：</label>
				    <div class="layui-input-block">
				      <input type="text" id="phonenumber" name="phonenumber" value="${user.phonenumber}" class="layui-input" >
				    </div>
				  </div>
				  <div class="layui-form-item">
				    <label class="layui-form-label">邮箱：</label>
				    <div class="layui-input-block">
				      <input type="text" name="email" id="email"  value="${user.email}" class="layui-input" >
				    </div>
				  </div>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" required lay-verify="required"  value="${user.password}" placeholder="请输入密码" autocomplete="off" class="layui-input" >
				    </div>
				  </div>
				  <div class="layui-form-item">
